...
public class UserController {
	 ...
	 * method.
	 */
	@PutMapping(value = "/api/v1/user/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<Void> updateUser(@RequestBody User user, @PathVariable(name = "id") String id) {
	 ...
	 */
	@DeleteMapping(value = "/api/v1/user/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	public ResponseEntity<Void> getUser(@PathVariable(name = "id") String id) {
		try {
